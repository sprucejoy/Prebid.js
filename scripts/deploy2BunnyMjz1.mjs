...
const ACCESSKEY = process.env.BUNNY_STORAGE_MJZ1_PASSWORD;
const endpoint = `https://${process.env.BUNNY_STORAGE_MJZ1_HOSTNAME}`;
const storageZoneName = `/${process.env.BUNNY_STORAGE_MJZ1_USERNAME}/`;
...
async function start() {
  console.time("Upload Files to mjz1 Edge Storage");
  ...
  console.timeEnd("Upload Files to mjz1 Edge Storage");

  fetch(
    `https://api.bunny.net/pullzone/${process.env.BUNNY_STORAGE_MJZ1_PULL_ZONE_ID}/purgeCache`,
